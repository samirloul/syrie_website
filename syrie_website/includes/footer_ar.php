    ...
    <div class="footer-content">
        ...
        <div class="footer-section">
            ...
            <ul style="list-style: none; padding:0;">
                ...
                <li><a href="about-syria_ar.php">عن سوريا</a></li>
                <li><a href="history_ar.php">التاريخ</a></li>
                <li><a href="culture_ar.php">الثقافة</a></li>
                <li><a href="geography_ar.php">الجغرافيا</a></li>
                <li><a href="economy_ar.php">الاقتصاد</a></li>
            </ul>
        </div>
