...
<head>
    ...
    <meta name="description" content="View beautiful photos and videos of Syria: historical monuments, landscapes, and cultural attractions.">
...
<body>
    ...
    <main>
        <section class="hero" style="background: linear-gradient(rgba(139, 69, 19, 0.8), rgba(218, 165, 32, 0.8)), url('images/gallery-hero.jpg'); background-size: cover; background-position: center;">
            <h1>Gallery</h1>
            <p>Discover the beauty of Syria through images</p>
        </section>
        ...
        <section class="filter-section text-center">
            <div class="filter-buttons">
                ...
                <button class="btn filter-btn" data-filter="image">Photos</button>
                <button class="btn filter-btn" data-filter="video">Videos</button>
            </div>
        </section>
        ...
        <section class="gallery-section">
            ...
            <div class="pagination-section text-center mt-2">
                <?php echo generatePagination($page, $total_items, $per_page, 'galerij.php'); ?>
            </div>
            
            <?php else: ?>
            <div class="no-items text-center">
                <h3>No items found</h3>
                <p>There are currently no gallery items available.</p>
            </div>
            <?php endif; ?>
        </section>
    </main>
